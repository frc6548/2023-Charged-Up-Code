...
public class executeTrajectory extends SequentialCommandGroup {
  public executeTrajectory(Swerve s_Swerve, PathPlannerTrajectory trajectory, boolean setInitialPose) {
    ...
    PIDController thetaController = new PIDController(
        Constants.AutonomousConstants.kPThetaController,
        0,
        0);
    ...
    PPSwerveControllerCommand swerveControllerCommand = new PPSwerveControllerCommand(
        ...
        new PIDController(Constants.AutonomousConstants.kPXController, 0, 0),
        new PIDController(Constants.AutonomousConstants.kPYController, 0, 0),
        thetaController,
